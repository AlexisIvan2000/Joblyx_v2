    ...
    async def test_success_flow(self, service, mock_session):
        ...
        with patch.object(service.career, 'get_career', return_value=career), \
             ...
             patch("services.roadmap.roadmap_service.call_gpt", return_value={
                 ...
                 "phases": [{"title": "Phase 1", "phase_number": 1, "duration_weeks": 4}],
             }):

            service.repo = AsyncMock()
            service.repo.create_roadmap.return_value = fake_roadmap
        ...
        service.repo.create_roadmap.assert_called_once()
        service.repo.create_phases.assert_called_once()
